        ...
        <div className="consulting-main-grid">
          ...
          <div id="lead-form">
            <div className="lead-form-card">
              ...
              <div style={{ marginTop: '28px', paddingTop: '20px', borderTop: '1px solid var(--glass-border)', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <p style={{ fontSize: '12px', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--secondary)' }}>
                  Atención Inmediata
                </p>
                <a
                  href="tel:8093786590"
                  style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--deep-navy)', fontWeight: '700', fontSize: '14px' }}
                >
                ...
                <a
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--secondary)', fontSize: '13px' }}
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
